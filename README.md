...
Generate optimized production assets (Tailwind compiled and minified, local images copied to `dist`):
...
For Vercel, deploy the `dist/` folder generated by `npm run build`.
